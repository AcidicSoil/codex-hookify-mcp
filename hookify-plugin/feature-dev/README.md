...
codex: Let me understand what you need...
...
- codex reads all identified files to build deep understanding
...
- Project guideline compliance (CODEX.md)
- Bug detection
- Code quality issues
