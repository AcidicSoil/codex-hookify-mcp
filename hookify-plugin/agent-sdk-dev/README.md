...
A comprehensive plugin for creating and verifying codex Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new codex Agent SDK application.
...
This plugin is included in the codex Code repository. To use it:

1. Ensure codex Code is installed
...
- Check that the SDK is installed: `pip show codex-agent-sdk`
