...
A comprehensive plugin for creating and verifying codex-cli Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new codex-cli Agent SDK application.
...
This plugin is included in the codex-cli Code repository. To use it:

1. Ensure codex-cli Code is installed
...
- Check that the SDK is installed: `pip show codex-cli-agent-sdk`
