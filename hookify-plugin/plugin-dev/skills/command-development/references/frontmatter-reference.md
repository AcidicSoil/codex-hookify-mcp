...
**Purpose:** Specify which codex-cli model executes the command
...
- codex-cli can invoke programmatically
...
**Best practices:**
- Use sparingly (limits codex-cli's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid codex-cli model
```
