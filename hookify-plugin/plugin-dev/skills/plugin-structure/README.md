...
Comprehensive guidance on codex-cli Code plugin architecture, directory layout, and best practices.
...
codex-cli loads references and examples only as needed based on the task.
