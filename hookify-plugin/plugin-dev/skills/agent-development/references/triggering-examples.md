...
assistant: "[How codex triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what codex says before launching the agent
...
**Purpose:** Show how codex invokes the agent
