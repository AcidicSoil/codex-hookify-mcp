...
Use this template to generate agents using codex-cli with the agent creation system prompt.
...
Send this to codex-cli (with the agent-creation-system-prompt loaded):
...
### Step 3: codex-cli Returns JSON

codex-cli will return:
...
Tell codex-cli when the agent should activate:
...
- **Comprehensive**: codex-cli includes edge cases and quality checks
