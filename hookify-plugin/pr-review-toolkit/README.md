...
Simply ask questions that match an agent's focus area, and codex-cli will automatically trigger the appropriate agent:
...
codex-cli may proactively use these agents based on context:
...
- User agents: `~/.codex-cli/agents/`
- Project agents: `.codex-cli/agents/` in codex-cli-cli-internal
