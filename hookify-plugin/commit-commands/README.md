...
- Includes codex Code attribution in commit message
...
This plugin is included in the codex Code repository. The commands are automatically available when using codex Code.
...
- **Let codex draft messages**: The commit message analysis learns from your repo's style
