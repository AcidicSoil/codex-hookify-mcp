...
- Includes codex-cli Code attribution in commit message
...
This plugin is included in the codex-cli Code repository. The commands are automatically available when using codex-cli Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let codex-cli analyze your changes and match your repo's commit style
...
- codex-cli will analyze the full branch history for the PR description
...
- **Let codex-cli draft messages**: The commit message analysis learns from your repo's style
